...
drift from the corpus. Output is plain static HTML — no build step, no external
assets — ready to publish to a CDN.
"""
...
<footer class="site-foot">
  ...
  <div class="wrap foot-bar"><p class="muted">Generated by <code>gen_website.py</code> — static output, no tracking.</p></div>
</footer>
</body>
</html>
"""
...
def main():
    ...
    print(f"Done — 4 pages + stylesheet + 3 exclusion files generated, "
